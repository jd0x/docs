...
rst_epilog = """
.. _Hasura Project Dashboard: https://dashboard.hasura.io
"""
...
htmlhelp_basename = 'HasuraPlatformdoc'
...
latex_documents = [
    (master_doc, 'HasuraPlatform.tex', 'Hasura Platform Documentation',
     'Tanmai Gopal', 'manual'),
]
...
man_pages = [
    (master_doc, 'hasuraplatform', 'Hasura Platform Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HasuraPlatform', 'Hasura Platform Documentation',
     author, 'HasuraPlatform', 'One line description of project.',
     'Miscellaneous'),
]
